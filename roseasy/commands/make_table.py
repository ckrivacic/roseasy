...
Usage:
    roseasy make_table <workspace> [<rounds>] [options]
...
def main():
    ...
    workspaces = pipeline.workspace_from_dir(args['<workspace>'])
    print(pipeline.load_resfile(args['<workspace>']))
    print(workspaces.resfile_path)
    if args['--design-list']:
